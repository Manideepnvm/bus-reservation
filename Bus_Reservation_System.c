...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"speed Travels","Rapid Express","Mega Express","Chennai Express","Titan Express","SunShine Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\tYour 180 rupees has been Returned\t\t\t\n"); 
    printf("======================================================================================================\n");
}
    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword); 
		if(strcmp(uname,"user")==0 && strcmp(pword,"itsme")==0)
	{
